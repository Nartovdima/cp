...
signed main() {
    ...
    line <ll> l1 (p1, p2), l2 (p3, p4);

    ld maindel = l1.a * l2.b - l2.a * l1.b;
    ld del1 = (-l1.c) * l2.b - (-l2.c) * l1.b;
    ld del2 = l1.a * (-l2.c) - l2.a * (-l1.c);

    if (maindel == 0) {
        if (l1.a * l2.c - l2.a * l1.c == 0 && l1.b * l2.c - l2.b * l1.c == 0)
            cout << 2 << '\n';
        else
            cout << 0 << '\n';
        return 0;
    ...
    cout << fixed << setprecision(5) << 1 << ' ' << del1 / maindel << ' ' << del2 / maindel << '\n';
    #ifdef _LOCAL
